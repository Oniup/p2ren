...
\assets
    ...
    \shaders
\src
    \glfwd_core     -- All modules below include, Window, Application facade
    \glfwd_renderer -- Forward renderer with OpenGL backend
    \glfwd_world    -- Managing the ECS and level population
    \glfwd_example  -- Example executable that loads the example map
CMakeLists.txt
...
README.md
```
