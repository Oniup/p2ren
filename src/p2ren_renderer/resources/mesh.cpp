...
Mesh Mesh::GenerateCube(const Material& material, glm::vec3 vertex_color)
{
...
Mesh Mesh::GeneratePlane(const Material& material, glm::vec3 vertex_color)
{
    glm::vec3 color1 = vertex_color == glm::vec3(0.0f) ? glm::vec3(1.0f, 0.0f, 0.0f) : vertex_color;
    glm::vec3 color2 = vertex_color == glm::vec3(0.0f) ? glm::vec3(0.0f, 1.0f, 0.0f) : vertex_color;
    glm::vec3 color3 = vertex_color == glm::vec3(0.0f) ? glm::vec3(0.0f, 0.0f, 1.0f) : vertex_color;
...
Mesh Mesh::GenerateSphere(size_t revolutions_x, size_t revolutions_y, const Material& material,
...
Mesh::Mesh(const std::vector<Vertex>& vertices, const Material& material, bool dynamic_draw)
{
...
Mesh::Mesh(const std::vector<Vertex>& vertices, const std::vector<uint32_t>& indices,
           const Material& material, bool dynamic_draw)
{
    Buffer array_buffer(Buffer::Array, dynamic_draw);
